...
//    var isinya bisa diubah (dinamis)
//    val isinya statis (final)
//    setelah val/var nama variabel lalu tipe data
//    kalo ada tanda tanya "?" bertanda mengizinkan datanya dapat null atau tidak
    ...
    constructor(
        id: Int, image: String, name: String, desc: String, distance: Int,
        address: String, district: String, operationalTime: List<String>?, numbTelp: String?,
        price: Int, latlong: String
    ) : this() {
        this.id = id
        this.image = image
        this.name = name
